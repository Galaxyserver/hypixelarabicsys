...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = ['Welcom To Hypixel Arabic','Type Hhelp'];
    var i = -1;
    var j = 0;
...
if (message.content.startsWith(prefix + 'help')) { /// This is The DMS Code Send The Help In DMS // Code By NotGucci
    let pages = [`**
        ***__General orders__***
**
H{prefix}allbots/لعرض جميع البوتات الي بالسيرفر
H{prefix}server/يعرض لك معلومات عن السيرفر
H{prefix}bot/يعرض لك كل معلومات البوت
H{prefix}count/يعرض لك عدد الاشخاص بالسيرفر بدون بوتات
H{prefix}invites/ يعرض لك  عدد انفايتاتك بالسيرفر 
H{prefix}invinfo <invitelink here> / لمعلومات عن الدعوه
 مثال : invinfo m82n8P
H{prefix}invite-codes/يعرض لك روابط الانفايتات حكك في السيرفر 
H{prefix}cal/اله حاسبة
H{prefix}trans <language> <any thing>/يترجم لك الي تبيه من اي لغة
H{prefix}short/يختصر لك رابط كبير الى رابط صغير
H{prefix}tag/يكتب لك الكلمة بشكل جميل وكبير
H{prefix}google/للبحث في قوقل عن طريق الدسكورد
H{prefix}perms/يعرض لك برمشناتك بالسيرفر
H{prefix}z5rf/يزخرف لك كلمة او جملة
H{prefix}rooms/يعرض لك كل الرومات الي بالسيرفر مع عددها
H{prefix}roles/يعرض لك كل الرانكات بالسيرفر بشكل جميل
H{prefix}emojilist/يعرض لك كل الايموجيات الي بالسيرفر
H{prefix}say/يكرر الكلام الي تكتبو
H{prefix}image/صورة السيرفر
H{prefix}members/عرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص
H{prefix}id/معلومات عنك
H{prefix}bans / عدد الاشخاص المبندة 
H{prefix}avatar/صورتك او صورة الي تمنشنو
H{prefix}embed/يكرر الي تقولو بشكل حلو
H{prefix}emoji <any things>/لتحويل اي كلمه تقولها الي ايموجي
H{prefix}inv/لدعوة البوت الى سيرفرك
H{prefix}support/سيرفر الدعم
H{prefix}contact/ارسال اقتراح او لمراسلة صاحب البوت
**
  `
,`
        ***__Administrative Orders__***
**
H{prefix}move @user /  لسحب الشخص الى روومك
H{prefix}bc / رسالة جماعية الى كل اعضاء السيرفر
H{prefix}bk / رسالة جماعيه مع
H{prefix}rolebc <everyone or @role> / راسال رساله جماعيه لرتبه محدده
H{prefix}role @user <rank> / لأعطاء رتبة لعضو معين
H{prefix}roleremove @user <rank> / لازالة الرتبة من شخص معين
H{prefix}give all <rank> / لأعطاء رتبة للجميع
H{prefix}give humans <rank> / لأعطاء رتبة للاشخاص فقط
H{prefix}give bots <rank> / لأعطاء رتبة لجميع البوتات
H{prefix}hchannel / اخفاء الشات
H{prefix}schannel / اضهار الشات المخفية
H{prefix}clr <numbr> / مسح الشات بعدد
H{prefix}clear / مسح الشات
H{prefix}mute @user <time> / اعطاء العضو ميوت 
H{prefix}unmute @user / لفك الميوت عن الشخص 
H{prefix}kick @user <reason> / طرد الشخص من السيرفر
H{prefix}ban @user <reason> / حضر الشخص من السيرفر
H{prefix}mutechannel / تقفيل الشات
H{prefix}unmutechannel / فتح الشات
H{prefix}dc / مسح كل الرومات
H{prefix}dr / <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات
H{prefix}ct <name> / انشاء شات
H{prefix}cv <name> / انشاء رووم فويس
H{prefix}temp / لانشاء روم مؤقت
H{prefix}delet <name> / مسح الشات او الرووم فويس
H{prefix}make <number> / ينشا لك الوان مع كم الوان تبي
H{prefix}color <number> / لختيار لون
H{prefix}deletecolors <number> / لحذف الالوان
**
   `,`
        ***__Music orders__***
**
H{prefix}play / لتشغيل أغنية برآبط أو بأسم
H{prefix}skip / لتجآوز الأغنية الحآلية
H{prefix}pause / إيقآف الأغنية مؤقتا
H{prefix}resume / لموآصلة الإغنية بعد إيقآفهآ مؤقتا
H{prefix}vol / لتغيير درجة الصوت 100 - 0
H{prefix}stop / لإخرآج البوت من الروم
H{prefix}np / لمعرفة الأغنية المشغلة حآليا
H{prefix}queue / لمعرفة قآئمة التشغيل
**
        ***__Games orders__***
 **       
H{prefix}rps / حجر ورقة مقص
H{prefix}speed / اسرع كتابة
H{prefix}quas / اسئلة عامة
H{prefix}نكت / نكت 
H{prefix}لعبة فكك / فكك
H{prefix}عواصم عشوائي/عواصم
H{prefix}لعبة كت تويت / كت تويت
H{prefix}roll <number> / قرعة
H{prefix}لو خيروك بطريقة حلوة / لو خيروك
H{prefix}لعبة مريم / مريم
H{prefix}فوائد ونصائح  / هل تعلم
H{prefix}يعطيك عقابات قاسية / عقاب 
=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.=.
welcome يتم الترحيب فى روم باسم
G.setwelcomer <text channel name> لاختيار روم للترحيب
H{prefix}voiceonline / لتفعيل روم الفويس اونلاين
**
